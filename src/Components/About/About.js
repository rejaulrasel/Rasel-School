...
import bgVideo2 from '../Home/video/home-bg-video.mp4'
    ...
    return (
        <div className='overflow-hidden'>
            ...
            <section className='registration'>
                ...
                <h1 className='text-center pt-5'>Take any <span className='text-warning'> Online course </span>and win $500 <br /> for your next class</h1>
