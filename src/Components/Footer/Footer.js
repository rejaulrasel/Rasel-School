            ...
            <div>
                <Row>
                    ...
                    <Col className='text-center p-5' sm={4}>
                        ...
                        <a href="a"><span className='icon'><i className="fab fa-facebook icon"></i></span></a>
                        <a href="a"><span className='icon'><i className="fab fa-instagram"></i></span></a>
                        <a href="a"><span className='icon'><i className="fab fa-whatsapp"></i></span></a>
                        <a href="a"><span className='icon'><i className="fab fa-twitter"></i></span></a>
                    </Col>
